          ...
          child: Column(
            children: [
              ...
              SectionCard(
                ...
                children: [
                  _tile(context, "Calendar", Icons.calendar_today,
                      const CalendarScreen()),
                  _tile(context, "Gmail", Icons.mail,
                      const GmailScreen()),
                  _tile(context, "Message", Icons.message,
                      const MessageScreen()),
                ],
              ),
...
SectionCard(
                title: "Data Privacy",
                children: [
                  _tile(context, "Data Encryption", Icons.lock, null),
                  _tile(context, "Clear History", Icons.history, null),
                  _tile(context, "Delete Account", Icons.delete, null),
                ],
              ),
              ...
              SectionCard(
                children: [
                  _tile(context, "Feedback", Icons.warning_amber,
